...
\begin{abstract} % put abstract here.
  Robot arms have been purposefully engineered to mimic the dexterity of human arms, yet they are not always controlled as such.
  In some cases, research has been undertaken to explore the performance impact of mapping the end effector of the robot arm to the operator's hand, with some cases of performance benefits.
  This project aims to explore the most appropriate method to crea
\end{abstract}%
\clearpage
