...
\label{sec:experiments}
  ...
  Analysis of variance (ANOVA) shows no significant deviation between each run (see appendix for detailed ANOVA results).
  ...
  \begin{figure}[h!]
    ...
    \caption{Average time spent in each phase for either control method.}
